...
"""
Optimizing checking for presence of "symbol".
"""
...
def count_occurrences(pattern, bwt, starts, occ_counts_before):
    ...
    while top <= bottom:
        if i >= 0:
            ...
            if occ_counts_before[bottom + 1][ALPHABET[symbol]] - occ_counts_before[top][ALPHABET[symbol]] > 0:
                top = starts[symbol] + occ_counts_before[top][ALPHABET[symbol]]
                bottom = starts[symbol] + occ_counts_before[bottom + 1][ALPHABET[symbol]] - 1
            else:
